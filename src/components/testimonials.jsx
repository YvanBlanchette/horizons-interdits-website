...
function TestimonialCard({ name, rating, img, children, bounds, scrollX, ...props }) {
	let ref = useRef(null);
	...
	return (
		<div>
			<p className="max-w-sm text-sm/6 text-gray-600">
				Want to be among the first to leave a review? Send me a note after you finish Book One, I read every message.
			</p>
			<div className="mt-2">
				<Link
					to="#newsletter"
