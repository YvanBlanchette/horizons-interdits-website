	...
	return (
		...
		>
			<div className="relative h-80 shrink-0">
				{graphic}
				{fade.includes("top") && <div className="absolute inset-0 bg-linear-to-b from-transparent from-80% to-white group-data-dark:from-gray-800" />}
				{fade.includes("bottom") && <div className="absolute inset-0 bg-linear-to-t from-white from-80% to-transparent group-data-dark:from-gray-800" />}
			</div>
